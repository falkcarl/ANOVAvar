...
ui <- fluidPage(
  plotOutput("ssbplot"),
  sliderInput("ssbscale", "Sum of squares model:",min=0,max=75,value=12.4,step=.2)
)
...
ui <- fluidPage(
  plotOutput("sswplot"),
  sliderInput("sswscale", "Sum of squares residual:",min=0.2,max=50,value=11.9,step=.2)
)
...
ui <- fluidPage(
  ...
  column(width = 2,   sliderInput("weight",
                                  "Proportion of variability due to model (between groups):",
...
- [Compute $SS_M$ for each dataset. Which dataset has the larger $SS_M$?]{style="color: blue;"}
...
We acknowledge the support from the Small Grants for Teaching Projects from the Association for Psychological Science (APS Fund for Teaching and Public Understanding of Psychological Science)